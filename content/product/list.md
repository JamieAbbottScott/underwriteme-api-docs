## List For Customer [/application/{existingApplicationId}/product{?lifeAssured}]
...
+ Parameters
    ...
    + lifeAssured  (required, string, `1502181407123020689`) ... Optional unique ID of existing Product Life Assured. If not specified, list all Life Assured.
